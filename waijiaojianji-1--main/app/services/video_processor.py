...
class VideoProcessorService:
    def __init__(self):
        ...
        self.bg_removal_service = None
        self.compositor_service = None
        self.name_overlay_service = None
        ...
        logger.info("视频处理服务初始化完成（延迟加载模式）")
